...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        log.info("La suma del precio de los electrodomesticos es de "+sumaElectrodomesticos);
        log.info("La suma del precio de las lavadoras es de "+sumaLavadoras);
        log.info("La suma del precio de las televisiones es de "+sumaTelevisiones);
    }
}
